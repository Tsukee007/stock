...
export default async function Home({
  ...
  return (
    <main className="bg-white">
      ...
      <section className="py-20 px-4 bg-blue-600">
        <div className="max-w-4xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 mb-6 bg-white rounded-xl px-4 py-2">
            <span className="text-2xl font-extrabold" style={{ color: '#635BFF' }}>Stripe</span>
          </div>
          <h2 className="text-3xl font-bold text-white mb-4" style={{ color: '#ffffff' }}>Vos paiements proteges par Stripe</h2>
          <p className="text-blue-100 max-w-xl mx-auto mb-12">
            Nestock ne gere jamais vos donnees bancaires directement. Chaque transaction passe par Stripe,
            l'infrastructure de paiement utilisee par des millions d'entreprises dans le monde, des plus petites
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-white rounded-2xl p-6">
              ...
              <h3 className="font-semibold text-gray-900 mb-2 text-sm">Vos donnees ne transitent jamais par Nestock</h3>
              <p className="text-gray-500 text-xs leading-relaxed">Numero de carte, IBAN : tout est traite directement par Stripe, chiffre de bout en bout.</p>
            </div>
            <div className="bg-white rounded-2xl p-6">
